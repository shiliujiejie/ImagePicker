...
class PhotoPreviewToolbarView: UIView {
    ...
    private func configView(){
        ...
        backArrow.setImage(backArrowImage, for: .normal)
    ...
    @objc func eventCheckbox(sender: UIButton){
        if sender.isSelected {
            ...
            UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.4, initialSpringVelocity: 8, options: [.curveEaseIn], animations: { () -> Void in
